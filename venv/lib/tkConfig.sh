...
# installed.
TK_PREFIX='/workspaces/OmniScan-XR2/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/workspaces/OmniScan-XR2/venv'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/workspaces/OmniScan-XR2/venv/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/workspaces/OmniScan-XR2/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/workspaces/OmniScan-XR2/venv/include'
...
# compiled.
TK_SRC_DIR='/workspaces/OmniScan-XR2/venv/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/workspaces/OmniScan-XR2/venv/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/workspaces/OmniScan-XR2/venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/workspaces/OmniScan-XR2/venv/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/workspaces/OmniScan-XR2/venv/lib/libtkstub8.6.a'
